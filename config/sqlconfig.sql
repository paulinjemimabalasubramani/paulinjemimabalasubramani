...
('CA_MIGRATE_PERSHING_RAA', 'DB_NAME', 'CA', 'System', CURRENT_TIMESTAMP),
...
('CA_MIGRATE_PERSHING_RAA', 'IS_FULL_LOAD', 'TRUE', 'System', CURRENT_TIMESTAMP),
...
('ASSETS_MIGRATE_PERSHING_RAA', 'IS_FULL_LOAD', 'TRUE', 'System', CURRENT_TIMESTAMP),
...
('ASSETS_MIGRATE_ALBRIDGE_WFS', 'REMOTE_PATH', '/usr/local/spark/resources/fileshare/APP01/Cluster/Albridge/WFS', 'System', CURRENT_TIMESTAMP),
...
('CA_MIGRATE_NBS', 'DB_NAME', 'CA', 'System', CURRENT_TIMESTAMP),
...
('CA_MIGRATE_CLIENTODS', 'DB_NAME', 'CA', 'System', CURRENT_TIMESTAMP),
