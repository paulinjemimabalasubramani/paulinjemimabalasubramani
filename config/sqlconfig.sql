...
(PipelineKey, ConfigKey, ConfigValue, UpdatedBy, UpdateTS)
VALUES
('FP_COPY_FINRA', 'DB_NAME', 'FP', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'SCHEMA_NAME', 'FINRA', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'FILE_HISTORY_START_DATE', '2021-05-15', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_FSC', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_RAA', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_SAA', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_SAI', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_SPF', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_TRD', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'REMOTE_PATH_WFS', '', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'SOURCE_PATH_FSC', '/opt/EDIP/data/FINRA/7461', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'SOURCE_PATH_RAA', '/opt/EDIP/data/FINRA/23131', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'SOURCE_PATH_SAA', '/opt/EDIP/data/FINRA/110518', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'SOURCE_PATH_SAI', '/opt/EDIP/data/FINRA/10205', 'System', CURRENT_TIMESTAMP),
('FP_COPY_FINRA', 'SOURCE_PATH_SPF', '/opt/EDIP/data/FINRA/133763', 'System', CURRENT_TIMESTAMP),
