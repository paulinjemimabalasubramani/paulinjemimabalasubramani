CREATE OR REPLACE PROCEDURE DATAHUB.PIPELINE_METADATA.POPULATE_INGESTION_TABLE_DETAILS_BKP("FILE_ID" VARCHAR, "FILE_TYPE" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS OWNER
AS 'DECLARE 
...
IF (:ENTRY_COUNT = 1) THEN
	RETURN ''ERROR : Already '' || :BRNZ_TABLE_NAME || '' is exist. Please alter the table if you want to add any new columns.'' ;
END IF;
