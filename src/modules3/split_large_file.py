...
if __name__ == "__main__":
    ...
    # source_file = "GACT.GACT.2024-11-28"   AccountsPerFile = 25000   trailer = "EOF"   trailer_format = "EOF  PERSHING GLOBAL ACTIVITY    DATA OF  11/27/2024 TO REMOTE FK6  ENDS HERE. TOTAL DETAIL RECORDS:  {1:010d}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Z"   rectype_start = 0   rectype_end = 3   seq_start = 3   seq_end = 11   record_start = 11   record_end = None   linesize = 751   dod_start = 46   dod_end = 56
    # python multiline_file_handle.py "GACT.GACT.2024-11-28"   25000   "EOF"   "EOF  PERSHING GLOBAL ACTIVITY    DATA OF  11/27/2024 TO REMOTE FK6  ENDS HERE. TOTAL DETAIL RECORDS:  {1:010d}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Z"    0  3  3   11  11   None   751   46   56
