...
from modules3.common_functions import catch_error, data_settings, logger, mark_execution_end, relative_copy_file, find_latest_folder, max_folder_name
...
remote_path = find_latest_folder(remote_path=data_settings.remote_path, folder_levels=folder_levels)
