...
from modules3.common_functions import catch_error, data_settings, logger, mark_execution_end, is_pc, name_regex
...
def generate_tables_from_fwt(
    ...
    elif 'asset_transfer_detail_record' in table_name.lower():
        start_ = 90
    else: 
