...
spark_app_name = "assets_migrate_albridge_tri"
...
with DAG(
    ...
    ASSETS_MIGRATE_ALBRIDGE_TRI = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_ALBRIDGE_TRI",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_ALBRIDGE_TRI',
    ...
    startpipe >> [ASSETS_MIGRATE_ALBRIDGE_TRI]
