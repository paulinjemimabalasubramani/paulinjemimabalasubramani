...
spark_app_name = "assets_migrate_albridge_sai"
...
with DAG(
    ...
    ASSETS_MIGRATE_ALBRIDGE_SAI = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_ALBRIDGE_SAI",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_ALBRIDGE_SAI',
    ...
    startpipe >> [ASSETS_MIGRATE_ALBRIDGE_SAI]
