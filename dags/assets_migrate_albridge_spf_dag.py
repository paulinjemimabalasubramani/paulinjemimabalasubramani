...
spark_app_name = "assets_migrate_albridge_spf"
...
with DAG(
    ...
    ASSETS_MIGRATE_ALBRIDGE_SPF = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_ALBRIDGE_SPF",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_ALBRIDGE_SPF',
    ...
    startpipe >> [ASSETS_MIGRATE_ALBRIDGE_SPF]
