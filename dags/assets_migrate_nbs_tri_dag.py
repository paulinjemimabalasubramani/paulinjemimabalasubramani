...
spark_app_name = "assets_migrate_nbs_tri"
airflow_app_name = spark_app_name
description_DAG = 'Migrate Assets NBS Tables'
...
with DAG(
    ...
    ASSETS_MIGRATE_NBS_TRI = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_NBS_TRI",
...
#             '--spark_master_ip', spark_master_ip,
    ...
    startpipe >> ASSETS_MIGRATE_NBS_TRI
