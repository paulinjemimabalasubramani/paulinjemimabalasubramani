...
spark_app_name = "Migrate Assets Plaid Tables"
airflow_app_name = "assets_migrate_plaid_sai"
...
with DAG(
    ...
    ASSETS_MIGRATE_PLAID_SAI = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_PLAID_SAI",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_PLAID_SAI',
...
#             '--spark_master_ip', spark_master_ip,
    ...
    startpipe >> ASSETS_MIGRATE_PLAID_SAI
