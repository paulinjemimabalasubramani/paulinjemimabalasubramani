...
spark_app_name = "assets_migrate_datastore_albridge_fsc"
airflow_app_name = spark_app_name
description_DAG = 'Migrate FSC Datastore Albridge data Tables'
...
with DAG(
    ...
    ASSETS_MIGRATE_DATASTORE_ALBRIDGE_FSC = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_DATASTORE_ALBRIDGE_FSC",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_DATASTORE_ALBRIDGE_FSC',
...
#             '--spark_master_ip', spark_master_ip,
    ...
    startpipe >> ASSETS_MIGRATE_DATASTORE_ALBRIDGE_FSC
