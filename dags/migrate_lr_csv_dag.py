...
spark_app_name = "Migrate LR CSV Tables"
airflow_app_name = "migrate_lr_csv"
description_DAG = 'Migrate LR CSV Tables'
...
with DAG(
    ...
    schedule_interval = '0 0,12 * * *', # https://crontab.guru/#0_0,12_*_*_*
    ...
    migratedata = SparkSubmitOperator(
         task_id = "migrate_lr_csv",
         application = "/usr/local/spark/app/migrate_lr_csv.py",
         name = spark_app_name,
         jars = jars,
