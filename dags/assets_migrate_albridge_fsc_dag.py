...
spark_app_name = "assets_migrate_albridge_fsc"
...
with DAG(
    ...
    ASSETS_MIGRATE_ALBRIDGE_FSC = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_ALBRIDGE_FSC",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_ALBRIDGE_FSC',
    ...
    startpipe >> [ASSETS_MIGRATE_ALBRIDGE_FSC]
