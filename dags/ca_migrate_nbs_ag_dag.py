...
spark_app_name = "ca_migrate_nbs"
airflow_app_name = spark_app_name
description_DAG = 'Migrate CA-NBS Tables'
...
with DAG(
    ...
    CA_MIGRATE_NBS = SparkSubmitOperator(
         task_id = "CA_MIGRATE_NBS",
