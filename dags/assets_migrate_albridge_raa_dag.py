...
spark_app_name = "assets_migrate_albridge_raa"
...
with DAG(
    ...
    ASSETS_MIGRATE_ALBRIDGE_RAA = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_ALBRIDGE_RAA",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_ALBRIDGE_RAA',
    ...
    startpipe >> [ASSETS_MIGRATE_ALBRIDGE_RAA]
