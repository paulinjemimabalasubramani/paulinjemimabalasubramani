...
spark_app_name = "Migrate NBS Tables"
airflow_app_name = "migrate_nbs"
description_DAG = 'Migrate NBS Tables'
...
with DAG(
    ...
    migratedata = SparkSubmitOperator(
         task_id = "migrate_nbs",
         application = "/usr/local/spark/app/migrate_nbs.py", # mapped to ..\EDIP-Code\src
         name = spark_app_name,
