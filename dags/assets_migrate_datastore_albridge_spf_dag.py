...
spark_app_name = "assets_migrate_datastore_albridge_spf"
airflow_app_name = spark_app_name
description_DAG = 'Migrate SPF Datastore Albridge data Tables'
...
with DAG(
    ...
    ASSETS_MIGRATE_DATASTORE_ALBRIDGE_SPF = SparkSubmitOperator(
         task_id = "ASSETS_MIGRATE_DATASTORE_ALBRIDGE_SPF",
         ...
         application_args = [
             '--pipelinekey', 'ASSETS_MIGRATE_DATASTORE_ALBRIDGE_SPF',
...
#             '--spark_master_ip', spark_master_ip,
    ...
    startpipe >> ASSETS_MIGRATE_DATASTORE_ALBRIDGE_SPF
