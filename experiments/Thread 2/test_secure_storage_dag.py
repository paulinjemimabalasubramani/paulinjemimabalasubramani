...
spark_app_name = "test_secure_storage"
airflow_app_name = "test_storage"
description_DAG='Test Secure Storage'
...
with DAG(
    ...
    migratelrdata = SparkSubmitOperator(
         ...
         application="/usr/local/spark/app/test_secure_storage.py", # mapped to M:\EDIP-Code\src
         name=spark_app_name,
